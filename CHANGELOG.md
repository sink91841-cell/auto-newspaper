...
## [1.6.0] - 2026-03-04
### 新增
- ✅ 全新Web界面：基于Flask框架开发的现代化Web界面，提供直观的操作体验
- ✅ 任务管理：支持创建、监控和管理报纸抓取任务，实时显示任务进度
- ✅ 定时任务系统：支持设置定时抓取任务，可配置执行时间和功能选项
- ✅ 历史记录管理：查看、下载和删除历史抓取记录
- ✅ 关键词管理：支持添加、编辑、删除关键词，以及关键词分类管理
- ✅ 新闻分类功能：基于关键词自动分类新闻内容
- ✅ 高级搜索：支持按日期、分类、报纸来源、关键词等多维度搜索新闻
- ✅ 新闻分析：提供高频关键词统计、相关新闻查询和关键词词云
- ✅ 数据导入导出：支持关键词的CSV格式导入导出

### 改进
- 🚀 响应式设计：适配不同屏幕尺寸，提供良好的移动端体验
- 🚀 后台任务处理：任务在后台运行，不阻塞Web界面操作
- 🚀 实时进度反馈：任务执行过程中实时更新进度和状态
...
- 🚀 图片处理优化：增强了图片压缩机制，确保文件大小符合API要求
- 🚀 数据库功能：优化了数据库连接和关闭逻辑
- 🚀 用户体验：提供更详细的错误信息和解决方案，优化了程序的稳定性和可靠性
